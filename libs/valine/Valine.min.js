...
*/
        ...
        (o.prototype.bind = function () {
          ...
          ;(e.$emoji = {
            ...
            (e.$preview = {
              show: function () {
                return (
                  j ? (e.$emoji.hide(), o.addClass('actived'), n.html(j).show(), M()) : e.$preview.hide(), e.$preview
                )
              },
              hide: function () {
                    ...
                    e.config.enableQQ &&
                      ...
                      (isNaN(n.val())
                        ? y.default.store.get(h.QQCacheKey) &&
                          ...
                          (y.default.store.remove(h.QQCacheKey), (E.nick = n.val()), (E.mail = ''), (E.QQAvatar = ''))
          ...
          var C = function (t, n, r) {
              ...
              i &&
                ...
                (a =
                  ...
                  (['xiaomi'].includes(i.browser.toLowerCase()) ? 'mobile-alt fas' : i.browser.toLowerCase()) +
                  '"></i>' +
                  i.browser +
                  ' ' +
                  i.version +
                  ...
                  ' ' +
                  ('<span class="vsys"><i class="fab fa-' +
                    (['mac os', 'ios'].includes(i.os.toLowerCase()) ? 'apple' : i.os.toLowerCase()) +
                    '"></i>' +
                    i.os +
                    ' ' +
                    i.osVersion +
              ...
              var ism = e.config.master.includes((0, s.default)(t.get('mail'))),
                ...
                gat = ism
                  ? '<span class="vtag vmaster">' + e.config.tagMeta[0] + '</span>'
                  : isf
                  ? '<span class="vtag vfriend">' + e.config.tagMeta[1] + '</span>'
                  : '<span class="vtag vvisitor">' + e.config.tagMeta[2] + '</span>'
              ...
              var l = t.get('link')
                  ...
                  : '',
                c = l
                  ? '<a class="vnick" rel="nofollow" href="' + l + '" target="_blank" >' + t.get('nick') + '</a>' + gat
                  : '<span class="vnick">' + t.get('nick') + '</span>' + gat,
                u = T.hide
                  ? ''
                  : qal
                  ? '<img class="vimg" src="' + qal + '" referrerPolicy="no-referrer"/>'
    ...
    function (e, t, n) {
      ...
      t.default = function (e, t) {
        ...
        i
          ? t && t()
          : o.default.sdkLoader('//cdn.jsdelivr.net/npm/leancloud-storage@3/dist/av-min.js', 'AV', function (n) {
              var r = 'https://',
                o = '',
                a = e.app_id || e.appId,
      ...
      var r = function (e) {
        ...
        var l = {
          Windows: function () {
            ...
            return (
              { 6.4: '10', 6.3: '8.1', 6.2: '8', 6.1: '7', '6.0': 'Vista', 5.2: 'XP', 5.1: 'XP', '5.0': '2000' }[t] || t
            )
          },
...
*/
    ...
    function (e, t) {
      e.exports = {
        ...
        总冠军: '4edd5c6290a1b6c98c478177f4fffe69539639eb.png',
        粽子: '177999fb7d70d891fbf63b161f26b272e08dc1de.png',
        母亲节: 'beb90b0547221f90ff6abd9c5ab07a6805ce3607.png',
        团宝: '311f83d568e2fd702b08f40d4c838572a07ebea0.png',
        泼水节: '69c9a9ef8ad147aaa69a98b2a817e297a52f30d1.png',
